...
return {status: true, author: "iwan", result:{title:get_video_data.data.title, link:`${baseUrl}/download/id?data=${encodeURIComponent(download_video_ucep.data.download_link.replace(/&/g, '%26').replace(/#/g, '%23').replace(/\+/g, '%2B'))}`}}
}
}
}
}else{
